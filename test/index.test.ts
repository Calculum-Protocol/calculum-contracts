...
const USDCe_ARB_ADDRESS = "0xFF970A61A04b1cA14834A43f5dE4533eBDDB5CC8";
const UNISWAP_ARB_ROUTER3 = "0xC31E54c7a869B9FcBEcc14363CF510d1c41fa443";
const USDCe_ARB_BIG_HOLDER = "0xb874005cbEa25C357b31C62145b3AEF219d105CF";
...
describe("Verification of Basic Value and Features", function () {
    ...
    before(async () => {
        ...
        USDc = await ethers.getContractAt(USDC_ABI, USDCe_ARB_ADDRESS);
        expect(USDc.address).to.be.properAddress;
        expect(USDc.address).to.be.equal(USDCe_ARB_ADDRESS);
